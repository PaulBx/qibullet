## Example scripts
* [Basic usage of the PepperVirtual class](pepper_basic.py)
* [Joint debug display, letting the user change joint's positions with cursors](pepper_joint_control.py)
